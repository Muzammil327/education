...
export default function Page() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const URL = `${process.env.NEXT_PUBLIC_API_KEY}get/heading3`
  ...
  const handleDeleteItem = async (_id: string) => {
    try {
      await axios.delete(`${process.env.NEXT_PUBLIC_API_KEY}delete/heading3/${_id}`)
      ...
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="pr-8 pl-10 py-3">
                Book Name
              </th>
              <th scope="col" className="pr-2 pl-10 py-3">
                Heading 2
              ...
              return (
                <>
                  ...
                  >
                    ...
                    <td className="py-4 pr-2 pl-10 "> {data.heading3}</td>
